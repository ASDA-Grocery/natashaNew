...
const awsURL = '18.191.59.68:3006';
...
//         }
        ...
        function distanceCalc(origin, destination, days, weight, size) {
          request(
            ...
            (err, res, body) => {
              ...
              var queryString = 'http://18.191.59.68:3006/createShipment?data='+JSON.stringify(shipmentDetails)+''
              superagent
                .get(queryString)
                .end((error, response)=>{
      ...
      if(timeOfDay === 'noTimeOfDay' || slotStartTime === 'noSlotStartTime'){
        ...
        if(slotStartTime === '9' || slotStartTime === 9){
            ...
            if(timeOfDay === 'AM' || timeOfDay === 'am' || timeOfDay === 'aM' || timeOfDay === 'Am' || timeOfDay === 'A.M.' || timeOfDay === 'a.m.' || timeOfDay === 'A.m.' || timeOfDay === 'a.M.' || timeOfDay === 'A.M' || timeOfDay === 'a.m' || timeOfDay === 'A.m' || timeOfDay === 'a.M'){
                speech = 'Okay! A pickup slot from 9 AM to 10 AM has been booked for you. Would you like any help packing the items? I can share a Do It Yourself tutorial video to your phone.'
            }
            else{
            ...
            if(timeOfDay === 'PM' || timeOfDay === 'pm' || timeOfDay === 'pM' || timeOfDay === 'Pm' || timeOfDay === 'P.M.' || timeOfDay === 'p.m.'|| timeOfDay === 'p.M.'|| timeOfDay === 'P.m.' || timeOfDay === 'P.M' || timeOfDay === 'p.m'|| timeOfDay === 'p.M'|| timeOfDay === 'P.m'){
                speech = 'Okay! A pickup slot from 12 PM to 1 PM has been booked for you. Would you like any help packing the items? I can share a Do It Yourself tutorial video to your phone.'
            }
            else{
                speech = 'Sorry! This slot is not available.'
            }            
            ...
            if(timeOfDay === 'PM' || timeOfDay === 'pm' || timeOfDay === 'pM' || timeOfDay === 'Pm' || timeOfDay === 'P.M.' || timeOfDay === 'p.m.'|| timeOfDay === 'p.M.'|| timeOfDay === 'P.m.' || timeOfDay === 'P.M' || timeOfDay === 'p.m'|| timeOfDay === 'p.M'|| timeOfDay === 'P.m'){
                speech = 'Okay! A pickup slot from 3 PM to 4 PM has been booked for you. Would you like any help packing the items? I can share a Do It Yourself tutorial video to your phone.'
            }
            else{
                speech = 'Sorry! This slot is not available.'
            }
            ...
            if(timeOfDay === 'PM' || timeOfDay === 'pm' || timeOfDay === 'pM' || timeOfDay === 'Pm'){
                speech = 'Okay! A pickup slot from 5 PM to 6 PM has been booked for you. Would you like any help packing the items? I can share a Do It Yourself tutorial video to your phone.'
            }
            else{
                speech = 'Sorry! This slot is not available.'
            }
        ...
        var queryString = 'http://18.191.59.68:3006/bookPickupSlot?data='+JSON.stringify(pickupSlot)+''
        superagent
          .get(queryString)
          .end((error, response)=>{
              console.log('Response received')
      ...
      var queryString = 'http://18.191.59.68:3006/findProducts?data='+JSON.stringify(myProductData)+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
      ...
      var queryString = 'http://18.191.59.68:3006/findSpecificProducts?data='+JSON.stringify(productName)+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
      ...
      var queryString = 'http://18.191.59.68:3006/optionsFindProducts?data='+JSON.stringify(myProductData)+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
      ...
      var queryString = 'http://18.191.59.68:3006/addToCart?data='+JSON.stringify(cartData)+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
      ...
      var queryString = 'http://18.191.59.68:3006/confirmCheckout?data='+JSON.stringify({'confirmCheckout': true})+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
      ...
      var queryString = 'http://18.191.59.68:3006/confirmDeliveryAddress?data='+JSON.stringify(deliveryDetails)+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
      ...
      var queryString = 'http://18.191.59.68:3006/confirmDeliveryTime?data='+JSON.stringify({'scheduledPickupTime': scheduledPickupTime})+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
      ...
      var queryString = 'http://18.191.59.68:3006/checkPackageStatus?data='+JSON.stringify(shipmentData)+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
      ...
      var queryString = 'http://18.191.59.68:3006/trackByPackageNumber?data='+JSON.stringify(shipmentDetails)+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')

...
const awsURL = '13.233.35.103:3006';
...
//         }
      ...
      if(timeOfDay === 'noTimeOfDay' || slotStartTime === 'noSlotStartTime'){
        ...
        var queryString = 'http://13.233.35.103:3006/bookPickupSlot?data='+JSON.stringify(pickupSlot)+''
        superagent
          .get(queryString)
          .end((error, response)=>{
              console.log('Response received')
      ...
      var queryString = 'http://13.233.35.103:3006/findProducts?data='+JSON.stringify(myProductData)+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
      ...
      var queryString = 'http://13.233.35.103:3006/findSpecificProducts?data='+JSON.stringify(productName)+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
      ...
      var queryString = 'http://13.233.35.103:3006/optionsFindProducts?data='+JSON.stringify(myProductData)+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
      ...
      var queryString = 'http://13.233.35.103:3006/addToCart?data='+JSON.stringify(cartData)+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
      ...
      var queryString = 'http://13.233.35.103:3006/confirmCheckout?data='+JSON.stringify({'confirmCheckout': true})+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
      ...
      var queryString = 'http://13.233.35.103:3006/confirmDeliveryAddress?data='+JSON.stringify(deliveryDetails)+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
      ...
      var queryString = 'http://13.233.35.103:3006/checkPackageStatus?data='+JSON.stringify(shipmentData)+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
      ...
      var queryString = 'http://13.233.35.103:3006/trackByPackageNumber?data='+JSON.stringify(shipmentDetails)+''
      superagent
        .get(queryString)
        .end((error, response)=>{
            console.log('Response received')
